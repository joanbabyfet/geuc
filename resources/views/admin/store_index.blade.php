    ...
    <div class="layui-card-body ">
        <form class="layui-form layui-col-space5" id="search-form" method="GET">
            <div class="layui-inline layui-show-xs-block">
                <input type="text" name="name" placeholder="請輸入店舖名稱" value="{{ request("name") }}" autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-inline layui-show-xs-block">
    ...
    <div class="layui-card-body ">
        <script type="text/html" id="toolbar">
            <div class="layui-btn-container">
                <a class="layui-btn layui-btn-sm" onclick="admin.openLayerForm('{{ route("admin.store.add") }}', '店舖添加', 'POST', '650px', '500px')"><i class="layui-icon"></i>新增</a>
        ...
        <table id="list" lay-filter="list" style="display: none"
            ...
            <tr>
                ...
                <th lay-data="{field:'name'}">店舖名稱</th>
                <th lay-data="{field:'shop_name_dis'}">所屬商家</th>
                <th lay-data="{field:'contact'}">聯絡人</th>
                <th lay-data="{field:'phone_dis'}">聯絡電話</th>
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs"
                           onclick="admin.openLayerForm('{{ route("admin.store.edit").'?id='.$v['id'] }}', '店舖編輯', 'POST', '650px', '500px')">編輯</a>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.store.delete").'?ids[]='.$v['id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            table.on('toolbar(list)', function(obj){
                ...
                switch(obj.event)
                {
                    ...
                    case 'export':
                        ...
                        _data.fields.push('shop_name_dis');
                        _data.fields.push('contact');
                        _data.fields.push('phone_dis');
                        _data.fields.push('status_dis');
                        _data.fields.push('create_time_dis');
                        export_excel('{{ route('admin.store.export_list') }}', _data, search_str);
                        break;
                }
            });
