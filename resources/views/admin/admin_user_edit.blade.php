<div class="layui-card-body ">
    <form id="layer-form" class="layui-form" action="{{ route("admin.admin_user.edit") }}" method="POST">
        {{ csrf_field() }}
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <select name="phone_code" lay-verify="">
                    <option value=""></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="safe_ips" value="{{ $row['safe_ips'] }}" placeholder="請輸入信任IP"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="session_expire" value="{{ $row['session_expire'] }}" placeholder="請輸入登錄時長"
