<div class="layui-card-body ">
    <form id="layer-form" class="layui-form" action="{{ route("admin.store.edit") }}" method="POST">
        {{ csrf_field() }}
        <input type='hidden' name='id' value="{{ $row['id'] }}"/>
        <div class="layui-form-item">
            <label class="layui-form-label label-required-next">店舖名稱:</label>
            <div class="layui-input-block">
                <input type="text" name="name" value="{{ $row['name'] }}" placeholder="請輸入店舖名稱"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="shop_id" lay-verify="required">
                    <option value=""></option>
                    {!! make_options($shop_options, $row['shop_id']) !!}
                </select>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="address" value="{{ $row['address'] }}" placeholder="請輸入店舖地址"
                       class="layui-input" required lay-verify="required">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="content" name="content" placeholder="請輸入店舖描述"
                          class="layui-textarea">{{ $row['content'] }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
