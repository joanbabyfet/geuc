...
@section('content')
    <div class="layui-card-body ">
        <form class="layui-form layui-col-space5" id="search-form" method="GET">
            ...
            <div class="layui-inline layui-show-xs-block">
                <input type="text" name="phone" placeholder="請輸入手機號" value="{{ request("phone") }}" autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-inline layui-show-xs-block">
    ...
    <div class="layui-card-body ">
        ...
        <table id="list" lay-filter="list" style="display: none"
            ...
            <tr>
                ...
                <th lay-data="{field:'content'}">短信内容</th>
                <th lay-data="{field:'send_time_dis'}">发送时间</th>
                <th lay-data="{field:'status_dis'}">状态</th>
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.sys_sms_log.delete").'?ids[]='.$v['id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
                    ...
                    case 'batch_del': //批量刪除
                        if(flag !== 0){
                            layui.layer.confirm('你確認刪除嗎？', {icon: 3, title: "提示", btn: ['確定', '取消']}, function (){
                                $.ajax({
                                    url: '{{ route('admin.sys_sms_log.delete') }}',
                                    type: 'POST',
