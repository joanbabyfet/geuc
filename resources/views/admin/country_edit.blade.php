<div class="layui-card-body ">
    <form id="layer-form" class="layui-form" action="{{ route("admin.country.edit") }}" method="POST">
        {{ csrf_field() }}
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="en_name" value="{{ $row['en_name'] }}" placeholder="請輸入英文名稱"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="en_short_name" value="{{ $row['en_short_name'] }}" placeholder="請輸入英文簡稱"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="mobile_prefix" value="{{ $row['mobile_prefix'] }}" placeholder="請輸入電話國碼"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" {!! $row['is_default'] == 1 ? 'checked="checked"':'' !!} name="is_default" lay-skin="switch" lay-filter="is_default"
                       lay-text="是|否">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" {!! $row['is_fix'] == 1 ? 'checked="checked"':'' !!} name="is_fix" lay-skin="switch" lay-filter="is_fix"
                       lay-text="是|否">
            </div>
        </div>
        <div class="layui-form-item">
