<div class="layui-card-body ">
    <form id="layer-form" class="layui-form" action="{{ route("admin.goods_cat.add") }}" method="POST">
        {{ csrf_field() }}
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
{{--                <input type="text" name="pid" value="0" placeholder="請輸入上級分類"--}}
{{--                       class="layui-input" required lay-verify="required">--}}
                <input type="text" name="pid" id="pid" lay-filter="pid"
    ...
    layui.use(['form', 'layedit', 'treeSelect'], function(){
        ...
        function get_options(store_id, id, element) {
            treeSelect.render({ //渲染
                ...
                success: function (d) {
                    if(store_id && id != 0) {
                        treeSelect.checkNode('pid', id); //选中节点，根据id筛选
                    }
