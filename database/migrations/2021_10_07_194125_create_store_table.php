...
class CreateStoreTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('store', function (Blueprint $table) {
            ...
            $table->char('shop_id', 32)->default(0)->nullable()->comment('所屬商家id');
            $table->string('name',50)->default('')->nullable()->comment('店舖名稱');
            ...
            $table->string('address',100)->default('')->nullable()->comment('店舖地址');
            $table->text("content")->nullable()->comment('店舖描述');
            $table->string('pictures',255)->default('')->nullable()->comment('店舖照片');
        ...
        $table = DB::getTablePrefix().'store';
        DB::statement("ALTER TABLE `{$table}` comment'店舖表'"); // 表注释
    }
