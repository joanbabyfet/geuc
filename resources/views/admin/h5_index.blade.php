    ...
    <div class="layui-card-body ">
        <form class="layui-form layui-col-space5" id="search-form" method="GET">
            <div class="layui-inline layui-show-xs-block">
                <input type="text" name="name" placeholder="請輸入標題" value="{{ request("name") }}" autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-inline layui-show-xs-block">
    ...
    <div class="layui-card-body ">
        <script type="text/html" id="toolbar">
            <div class="layui-btn-container">
                <a class="layui-btn layui-btn-sm" onclick="admin.openLayerForm('{{ route("admin.h5.add") }}', 'H5添加', 'POST', '600px', '400px')"><i class="layui-icon"></i>新增</a>
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-xs layui-btn-primary"
                           onclick="admin.openLayerIframe('{{ $v['url'] }}', 'H5查看', false, '600px', '500px')">查看</a>
                        <a class="layui-btn layui-btn-xs"
                           onclick="admin.openLayerForm('{{ route("admin.h5.edit").'?id='.$v['id'] }}', 'H5編輯', 'POST', '600px', '400px')">編輯</a>
                        <a class="layui-btn layui-btn-xs layui-btn-danger"
                           onclick="admin.tableDataDelete('{{ route("admin.h5.delete").'?ids[]='.$v['id'] }}', this)">刪除</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
            ...
            table.on('toolbar(list)', function(obj){
                ...
                switch(obj.event)
                {
                    ...
                    case 'export':
                        ...
                        export_excel('{{ route('admin.h5.export_list') }}', _data, search_str);
                        break;
                }
            });
